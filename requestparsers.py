...
household_get_args = reqparse.RequestParser() # help
...
household_put_args.add_argument('individuals', type=list, case_sensitive=False, trim=True)
household_put_args.add_argument('housingtype', type=str, case_sensitive=False, trim=True, choices=housing_type_choices, required=True)
...
individual_get_args = reqparse.RequestParser() # help
...
individual_put_args.add_argument('nric', type=str, case_sensitive=False, trim=True, required=True)
individual_put_args.add_argument('name', type=str, case_sensitive=False, trim=True, required=True)
individual_put_args.add_argument('gender', type=str, case_sensitive=False, trim=True, choices=gender_choices, required=True)
individual_put_args.add_argument('maritalstatus', type=str, case_sensitive=False, trim=True, choices=marital_status_choices, required=True)
individual_put_args.add_argument('spouse', type=str, case_sensitive=False, trim=True)
individual_put_args.add_argument('occupationtype', type=str, case_sensitive=False, trim=True, choices=occupation_type_choices, required=True)
individual_put_args.add_argument('annualincome', type=int, required=True)
individual_put_args.add_argument('dateofbirth', type=str, case_sensitive=False, trim=True, required=True)
